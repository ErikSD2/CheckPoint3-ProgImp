...
const David = new Aluno("David", (Math.random() * 10) | 0, [
  (Math.random() * 10) | 0,
  (Math.random() * 10) | 0,
  (Math.random() * 10) | 0,
]);
const Erik = new Aluno("Erik", (Math.random() * 10) | 0, [
  (Math.random() * 10) | 0,
  (Math.random() * 10) | 0,
  (Math.random() * 10) | 0,
]);
const Gabriel = new Aluno("Gabriel", (Math.random() * 10) | 0, [
  (Math.random() * 10) | 0,
  (Math.random() * 10) | 0,
  (Math.random() * 10) | 0,
]);
const Luis = new Aluno("Luis", (Math.random() * 10) | 0, [
  (Math.random() * 10) | 0,
  (Math.random() * 10) | 0,
  (Math.random() * 10) | 0,
]);
const Mahiny = new Aluno("Mahiny", (Math.random() * 10) | 0, [
  (Math.random() * 10) | 0,
  (Math.random() * 10) | 0,
  (Math.random() * 10) | 0,
]);
const Wagner = new Aluno("Wagner", (Math.random() * 10) | 0, [
  (Math.random() * 10) | 0,
  (Math.random() * 10) | 0,
  (Math.random() * 10) | 0,
]);
...
let curso = {
  ...
  faltasMax: 3,
  notaAprovacao: 4,
  listaEstudantes: [David, Erik, Gabriel, Luis, Mahiny, Wagner],
  // Passo 4
  novoAluno: function () {
  ...
  aprovado: function (aluno) {
    ...
    let media = parseInt(
      notas.reduce((prev, curr) => prev + curr) / notas.length
    );

    if (faltas <= this.faltasMax && media >= this.notaAprovacao) {
      return true;
    }
    return false;
  },
